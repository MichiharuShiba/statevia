...
describe("GraphLegend", () => {
  ...
  it("全エッジ種別を表示する", () => {
    render(<GraphLegend />);
    expect(screen.getByText(uiText.graphLegend.edgeKind.nextTraversed)).toBeInTheDocument();
    expect(screen.getByText(uiText.graphLegend.edgeKind.nextNotTraversed)).toBeInTheDocument();
