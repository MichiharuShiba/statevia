...
namespace Statevia.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260902142301_AddLoginFailureLocks")]
    partial class AddLoginFailureLocks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Statevia.Core.Application.Contracts.Persistence.ExecutionCheckpointDocument", b =>
                {
                    ...
                    b.Property<long>("OwnerGeneration")
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Statevia.Infrastructure.Persistence.LoginFailureAttemptRow", b =>
                {
                    ...
                    b.HasIndex("TenantKey", "Username", "FailedAt");

                    b.ToTable("login_failure_attempts", (string)null);
                });

            modelBuilder.Entity("Statevia.Infrastructure.Persistence.LoginFailureLockRow", b =>
                {
                    b.Property<string>("TenantKey")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                    ...
                    b.HasKey("TenantKey", "Username");

                    b.HasIndex("LockedUntil");

                    b.ToTable("login_failure_locks", (string)null);
                });
            ...
            modelBuilder.Entity("Statevia.Infrastructure.Persistence.LoginFailureAttemptRow", b =>
                {
                    b.HasOne("Statevia.Infrastructure.Persistence.LoginFailureLockRow", null)
                        .WithMany()
                        .HasForeignKey("TenantKey", "Username")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
