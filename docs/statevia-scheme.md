...
erDiagram
  ...
  workflows ||--o{ execution_events : "execution_id"
...
- **event_store** / **execution_events** / **execution_graph_snapshots** → **workflows.workflow_id**（7a 以降の物理名は `executions.execution_id`。task 10 で ER 全体を再同期予定）。
