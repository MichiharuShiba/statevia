...
/// <summary><see cref="WorkflowServiceLogMessages"/> とログ詳細 DTO のテスト。</summary>
public sealed class WorkflowServiceLogMessagesTests
{
    ...
    public void SerializablePersistRetry_EmitsStructuredLog()
    {
        ...
        var logger = factory.CreateLogger<WorkflowService>();
        var details = new SerializablePersistRetryDetails
        {
            TraceId = "trace-1",
            WorkflowId = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
            TenantId = "t1",
