...
/// <summary>
/// <see cref="IWorkflowMutationPersistence"/> の実装。
/// </summary>
internal sealed class WorkflowMutationPersistence : IWorkflowMutationPersistence
{
    ...
    private readonly ILogger<WorkflowMutationPersistence> _logger;

    /// <summary>
    /// 新しいインスタンスを初期化する。
    /// </summary>
    public WorkflowMutationPersistence(
        ...
        ILogger<WorkflowMutationPersistence> logger)
    {
