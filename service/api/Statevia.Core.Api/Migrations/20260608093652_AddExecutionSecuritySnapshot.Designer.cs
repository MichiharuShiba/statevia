...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.ApiKeyRow", b =>
                {
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.EventDeliveryDedupRow", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid")
                        .HasColumnName("tenant_id");
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.ExecutionCursorRow", b =>
                {
                    b.Property<Guid>("ExecutionId")
                        .HasColumnType("uuid")
                        .HasColumnName("execution_id");
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.ExecutionEventRow", b =>
                {
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.ExecutionWaitRow", b =>
                {
                    b.Property<Guid>("ExecutionId")
                        .HasColumnType("uuid")
                        .HasColumnName("execution_id");
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.GroupRow", b =>
                {
                    b.Property<Guid>("GroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.PermissionDefinitionRow", b =>
                {
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.PrincipalRow", b =>
                {
                    b.Property<Guid>("PrincipalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.ServiceAccountGroupMemberRow", b =>
                {
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.TenantRow", b =>
                {
                    b.Property<Guid>("TenantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.UserGroupMemberRow", b =>
                {
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.UserPrincipalRow", b =>
                {
                    b.Property<Guid>("PrincipalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.UserRow", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Statevia.Core.Api.Persistence.ExecutionCursorRow", b =>
                {
                    b.HasOne("Statevia.Core.Api.Persistence.ExecutionRow", null)
                        .WithMany()
