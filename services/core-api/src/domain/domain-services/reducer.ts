/**
 * Reducer ドメインサービス
 * イベントを適用して ExecutionState を更新する
 */
import { ExecutionState, ExecutionStatus, NodeStatus } from "../value-objects/execution-state.js";
import { EventEnvelope } from "../value-objects/event-envelope.js";
